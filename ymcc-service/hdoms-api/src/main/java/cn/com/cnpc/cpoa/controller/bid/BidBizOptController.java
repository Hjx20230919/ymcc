...
public class BidBizOptController extends BaseController {
    ...
    @RequestMapping(method = RequestMethod.DELETE, value = "/delete/{bizOptId}",produces = "application/json")
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/{bizOptId}",produces = "application/json")
