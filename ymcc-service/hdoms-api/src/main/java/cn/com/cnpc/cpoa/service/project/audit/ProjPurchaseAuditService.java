...
//
//
//    BizProjPurcPlanDto bizProjPurcPlanDto = projPurcPlanService.selectByKey(auditVo.getObjId());
//    String projId = bizProjPurcPlanDto.getProjId();
//    BizProjProjectDto projProjectDto = projProjectService.selectByKey(projId);
//
//    //3 同级操作是否还有未处理的
//    if (!activitiService.hasNoDealStep(auditVo)) {
//        //最后一步则要新增 准入申请等信息
