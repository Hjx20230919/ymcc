...
@Api(tags = "采购结果管理")
@RestController
@RequestMapping("/hd/project/projPurcResult")
public class BizProjPurcResultController extends BaseController {
    ...
    @RequestMapping(value = "/resultList", method = RequestMethod.GET,produces = "application/json")
    ...
    @RequestMapping(value = "/maintain/{resultId}", method = RequestMethod.PUT,produces = "application/json")
    ...
    @RequestMapping(value = "/submit/{id}", method = RequestMethod.PUT,produces = "application/json")
    ...
    @RequestMapping(value = "/pdf", method = RequestMethod.GET,produces = "application/json")
    ...
    @RequestMapping(value = "/freeze/{resultId}", method = RequestMethod.GET,produces = "application/json")
    ...
    @RequestMapping(value = "/unfreeze", method = RequestMethod.GET,produces = "application/json")
