...
public class ExcelUtil<T>
{
    ...
    public List<T> importExcel2(String filename,InputStream is) throws Exception
    {
        return importExcel1(filename,StringUtils.EMPTY, is);
    }
...
//            }
    ...
    public List<T> importExcel1(String filename,String sheetName, InputStream is) throws Exception
    {
