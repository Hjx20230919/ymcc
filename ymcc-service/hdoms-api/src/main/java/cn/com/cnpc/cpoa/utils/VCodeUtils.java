...
//    }
    ...
    public static String getCode(OutputStream outputStream){
        try {
            VCodeUtils vc = new VCodeUtils();
            Map<String, Object> imageMap = vc.getImage();
            saveImage((BufferedImage) imageMap.get("img"), outputStream);

            return String.valueOf(imageMap.get("sb"));
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        try {
            VCodeUtils vc = new VCodeUtils();
            Map<String, Object> imageMap = vc.getImage();
            saveImage((BufferedImage)imageMap.get("img"), new FileOutputStream("D:/a.jpg"));
            System.out.println((String)imageMap.get("sb"));
        } catch (Exception e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
