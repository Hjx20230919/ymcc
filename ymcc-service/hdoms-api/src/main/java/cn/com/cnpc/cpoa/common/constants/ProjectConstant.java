...
//            tenderingMap.put(REPURCHASESERVICE, TENDERINGPURCHASE);
    ...
    static {
        accessTypeMap.put("川庆准入", "■公司准入 □院准入   □公司临时准入");
        accessTypeMap.put("集团准入", "■公司准入 □院准入   □公司临时准入");
        accessTypeMap.put("院准入", "□公司准入 ■院准入   □公司临时准入");
        accessTypeMap.put("temporary", "□公司准入 □院准入   ■公司临时准入");
    }
