...
//            String res = HttpUtil.get(userInfo+"?code="+code);
     ...
     * @return
     */
    @RequestMapping(value = "/binding", method = RequestMethod.PUT,produces = "application/json")
     ...
     * @return
     */
    @RequestMapping(value = "/unBinding/{id}", method = RequestMethod.PUT,produces = "application/json")
