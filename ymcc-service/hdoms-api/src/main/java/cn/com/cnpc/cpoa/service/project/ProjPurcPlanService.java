...
public class ProjPurcPlanService extends AppService<BizProjPurcPlanDto> {
    ...
    public BizProjPurcPlanDto addProjPurcPlan(ProjPurcPlanVo vo, String userId, String type) throws Exception {
        ...
        dto.setProjPhase(ProjPhaseEnum.REPURCHASE.getKey());
        ...
        //保存附件
        String proToFileUri = attachService.getProToFileUri(ProjPhaseEnum.REPURCHASE.getKey(), projProjectDto.getSelContType(), projProjectDto.getDealNo());
