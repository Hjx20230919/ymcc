...
public class UserController extends BaseController {
    ...
    public AppMessage getCurrentUser() {
        ...
        List<SysUserDto> sysUserDtos = userService.selectAll();
//        SysUserDto sysUserDto = userService.selectByKey("3985518face749fda7f25fe1aa83baeb");
    ...
    public void getVerificationCode(HttpServletResponse response, @RequestParam(value = "account") String account) throws Exception {
