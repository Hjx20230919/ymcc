...
public class Constants {
   ...
   // public static final String THKN = "THKN";
    ...
    static {
        dealStatisticsNameMap2.put("中国石油集团川庆钻探工程有限公司安全环保质量监督检测研究院", "安检院");
        dealStatisticsNameMap2.put("四川科特检测技术有限公司", "科特");
        dealStatisticsNameMap2.put("川庆钻探工程有限公司伊拉克分公司", "伊分公司");
        dealStatisticsNameMap2.put("宏大公司", "宏大公司");
    }
