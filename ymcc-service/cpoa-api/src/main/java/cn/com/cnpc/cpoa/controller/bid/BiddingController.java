...
public class BiddingController extends BaseController {
    ...
    @RequestMapping(method = RequestMethod.DELETE, value = "/delete/{biddingId}")
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/stop/{biddingId}")
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/send/{biddingId}/{userId}")
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/audit/approve")
