...
public class BizDealExService extends AppService<BizDealExDto> {
    ...
    @Transactional
    public boolean saveChain(BizDealExDto dealExDto, String type)throws Exception{
        BizDealExDto bizDealExDto = selectByKey(dealExDto.getDealId());
        if(null!=bizDealExDto){
